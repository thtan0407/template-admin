...
${data_hours == 23 ? '<tr data-date-time="24:00"></tr>' : ''}`
    ...
    addCustomer('18:00', '18:30', '18:45', 2, {color: '#3a87ad', mess: true, cCount: 4, isProcess: true, extra: 15, classCus: ['cus-02', 'paid' ,'free-axis', 'sv-1']});
    ...
    addCustomer('22:15', '23:00', '24:00', 6, {color: '#8FD400', cCount: 2, isProcess: true, isNew: true, classCus: ['cus-03', 'booking', 'free-axis', 'sv-3']});
    ...
    addCustomer('22:00', '22:30', '23:30', 4, {color: '#FE0883', isNew: true, classCus: ['cus-04', 'booking', 'free-axis', 'sv-2']});
    ...
    addCustomer('17:00', '17:30', '17:45', 2, {color: '#C63D2D', classCus: ['cus-05','booking', 'free-axis', 'sv-3']});
    ...
    addCustomer('22:30', '23:00', '24:00', 12, {color: '#910101', isNew: true, classCus: ['cus-06','booking', 'free-axis', 'sv-2']});
...
<input type="hidden" class="timeE" value="${timeEnd}">`;
    ...
    let eleTempalte = `
    <div class="sch-event ev-draggable ${opt.classCus.map(cl => `${cl}`).join(' ')}" style="top:${topPosY}px;height:${bottomPosY - topPosY}px">
